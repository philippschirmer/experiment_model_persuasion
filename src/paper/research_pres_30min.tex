...
\title{Experiment Model Persuasion}

\author[Carolina Alvarez Garavito, Philipp Schirmer]
{
{\bf Carolina Alvarez Garavito, Philipp Schirmer}\\
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \item<+-> a %\citet{Schelling69} example in the code is taken from \citet{StachurskiSargent13}.
