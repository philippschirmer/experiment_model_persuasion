...
doc = """
Demo of a reduced form model-persuasion game, where only the receiver side is modelled.
"""
...
class C(BaseConstants): #base constants that do not vary from player to player
    NAME_IN_URL = 'persuasion_receiver_only'
    PLAYERS_PER_GROUP = None
    NUM_ROUNDS = 1
    SHOW_UP_FEE= cu(500)
    INSTRUCTIONS_TEMPLATE = 'persuasion_receiver_only/instructions.html' #general instructions
...
class Player(BasePlayer):
    ...
    # WIP: Just placeholder forms for the most part
    ...
    ## Receiver Thought Process questions.

    itemFreeFormModel = models.StringField(
    label = "When you observe this graph, what model do you think predicts the next stock prices?"
    )


    ## Plausible Models elicitation
...
class DecisionReceiver1(Page):
    ...
    def vars_for_template(player):
        ...
        # For one-sided game, send preselected message.
...
### New classes/pages for the receiver side

class ThoughtProcessReceiver(Page):

    # TODO: Page to elicit the ideas of the receiver in free form, i.e. text boxes.

    # TODO: How to do this best; show/explain model, ask for interpretation?
    # TODO: Alternative: Show financial graph, ask for interpretation?


    form_model = 'player'
    # TODO: Need to change the form fields
    form_fields = [
    'itemFreeFormModel'
    ]
    @staticmethod
...
class ThoughtProcessReceiver2(Page):
    # TODO: second page to elicit receiver's thought process. Content TBD.    
    pass

class ReceiverIntroToDecisions(Page):
    # TODO: Intro page to teach receivers about the model choice problem:
    pass

class ModelPlausibilityReceiver(Page):
    # TODO: Ask about different models for what might predict stock prices/returns.
    pass

class ModelPrior(Page):
    # TODO: For a selection of possible models, ask receivers to assign points to how likely it is 
    # a given model is the true model:
    # In a way eliciting the model prior before the data.
    pass



page_sequence = [Introduction,
                ThoughtProcessReceiver,
                # PersuaderPage, 
                # BiasedPage, 
                # BiasedPage_Q,
                # AlignedPage,
